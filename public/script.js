...
function initMobileNav() {
  ...
  // Inject Mobile Nav Quick Actions if not present
  if (!navLinks.querySelector('.mobile-nav-cta')) {
    const mobileCta = document.createElement('div');
    mobileCta.className = 'mobile-nav-cta';
    mobileCta.innerHTML = `
      <a href="https://api.whatsapp.com/send?phone=923124038455&text=Hi%20Mudassar%20Alk,%20I%20would%20like%20to%20discuss%20SEO%20services." target="_blank" rel="noopener noreferrer" class="mobile-contact-pill" style="background: #f0fdf4; border-color: #bbf7d0; color: #166534;">
        ...
        <span>WhatsApp: <strong>+92 312 4038455</strong></span>
      </a>
      <a href="tel:+923124038455" class="mobile-contact-pill">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
        <span>Call: <strong>+92 312 4038455</strong></span>
      </a>
      <a href="mailto:info@seoranker.site" class="mobile-contact-pill">
        ...
        <span>Email: <strong>info@seoranker.site</strong></span>
      </a>
      <a href="contact.html" class="btn btn-primary btn-sm" style="width: 100%; justify-content: center; margin-top: 0.25rem;">
        Get Free SEO Audit →
      </a>
    `;
  ...
  links.forEach(link => {
    link.addEventListener('click', () => {
      // Don't close if it's the parent dropdown trigger link on mobile
